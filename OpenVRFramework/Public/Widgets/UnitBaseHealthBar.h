...
UCLASS()
class OPENVRFRAMEWORK_API UUnitBaseHealthBar : public UUserWidget
{
	GENERATED_BODY()
...
//private:	
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = OpenVRFramework) // EditAnywhere, BlueprintReadWrite, 
